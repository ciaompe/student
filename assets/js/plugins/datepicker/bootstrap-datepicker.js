...
!function( $ ) {
	...
	var Datepicker = function(element, options) {
		...
		if (this.isRTL){
			...
			this.picker.find('.prev i, .next i')
						.toggleClass('icon-arrow-left glyphicon-arrow-left icon-arrow-right glyphicon-arrow-right');
		}
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="elusive icon-arrow-left glyphicon glyphicon-arrow-left"/></th>'+
								'<th colspan="5" class="datepicker-switch"></th>'+
								'<th class="next"><i class="elusive icon-arrow-right glyphicon glyphicon-arrow-right"/></th>'+
							'</tr>'+
						'</thead>',
